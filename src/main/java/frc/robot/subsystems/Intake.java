...
public class Intake extends SubsystemBase {
    ...
    public Command manualIntake(CommandXboxController xbox){
        return run(() -> {
            ...
            if (intakeMotor.getMotorTemperature() > 69 || intakeMotor.getMotorTemperature() == 0) speed = 0;
            set(speed);
        });
    }
    ...
    public void periodic() {
        SmartDashboard.putNumber("Intake Tempurature", intakeMotor.getMotorTemperature());
    }
}
